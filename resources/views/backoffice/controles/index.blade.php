							...
							<tr class="border-b border-gray-200 hover:bg-gray-100">
								...
								<td class="py-3 px-6 text-center">               
									...
									<div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
										<a href="{{route('showConformity',$state_control->id)}}">
									...
									<div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
										<a href="{{route('editConformity',$state_control->id)}}">
										<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
									...
									<div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
										<form action="{{route('desactiveConformity',$state_control->id)}}" method="post">
										@csrf
									...
									<div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
										<form action="{{route('destroyConformity',$state_control->id)}}" method="post">
										@csrf
										<button type="submit" name="destroy" class="w-4 h-4">
