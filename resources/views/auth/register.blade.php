<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
            <x-label for="client_type" :value="__('Type de Client')" />
               <select class="border-0 p-4 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full" name="client_type" id="client_type" required>
            ...
            <div>
                ...
                <x-input id="name" class="border-0 p-4 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full" type="text" name="name" :value="old('name')" required autofocus />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="email" class="border-0 p-4 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full" type="email" name="email" :value="old('email')" required />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="password_confirmation" class="border-0 p-4 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full"
                                type="password"
